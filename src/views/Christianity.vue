<template>
	...
	<p class="text-body-1 mb-3">While we do not know which sect Jesus belonged to, and he may not have been part of any sect, we do know that he shares a lot of similarities with the Pharisees, which is what led to him debate more frequently with them. The Pharisees and Jesus both held the Torah, Prophets, and Writings as sacred, in contrast to the Sadducees, who did not. The Phraisees and Jesus, therefore, also held the belief of angels, heaven, and Satan which are developed within and from the Prophets and Writings of the Tanakh (Old Testament).</p>
