...
<script lang="ts" setup>
	...
	var contextualTheologyBooks = ref([
		...
		{ category: "LGBTQ+", name: "Wrestling with God & Men: Homosexuality in the Jewish Tradition", author: "Rabbi Steven Greenberg", awards: "2005 Koret Jewish Book Award for Philosophy and Thought", tradition: "Judaism" },
