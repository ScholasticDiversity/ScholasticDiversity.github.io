<template>
	...
	<p class="text-body-1 mb-3">In Babylonia, they interact with Zoroastrianism, which was monotheistic at the time. During this time, many already-developed stories and texts are edited and revised in light of the fall of Judah and the start of the Diaspora in order to explain these events through a new perspective on the past. They do this by compiling and editing (redacting) these stories, which become the Torah and Deuteronomistic History (Genesis to 2 Kings, excluding Ruth), in a way that shows the cycle of sin and repentance of the people. This cycle sin and repentance explained Theologically the reasons of the Diaspora at the time.</p>
	<p class="text-body-1 mb-3">One other important development during this time was the shift from a God that is limited to a place and was thought to be inferior to the god(s) of the conquerors to a God that <em>uses</em> the conquerors to punish the people. This is what allowed the people to continue the religion when usually they might have assimilated, and what furthered the development of monotheism and an All-powerful God of <em>everyone</em>.</p>
