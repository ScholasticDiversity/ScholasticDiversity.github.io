...
<script lang="ts" setup>
	...
	var books = ref([
		...
		{ category: "General", name: "To Pray As A Jew", author: "Rabbi Hayim Halevy Donin", awards: "", tradition: "Orthodox" },
		...
		{ category: "Bible, Bible Interpretation", name: "The Jewish Annotated New Testament (2nd ed.)", author: "Amy-Jill Levine, Marc Zvi Brettler", awards: "", tradition: "Judeo-Christian" },
		...
		{ category: "Ritual, Halakhah, Theology, Feminist", name: "My People's Prayer Book Series", author: "Rabbi Lawrence A. Hoffman, et al.", awards: "National Jewish Book Awards", tradition: "All" },
