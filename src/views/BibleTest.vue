...
<script lang="ts" setup>
    ...
    var questions = ref([
        ...
        { q: "How many sets of tablets for the covenant (or 10 commandments) were there in the first 4 books of the Bible? What happens to the tablets in the book of Exodus, and why?", choices: [""], correctChoice: 0, explanation: "" },
