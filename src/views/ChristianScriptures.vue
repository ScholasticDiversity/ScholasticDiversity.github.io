<template>
	<v-breadcrumbs>
		...
		<v-breadcrumbs-item title="Christian" active :to="{ name: 'christianscriptures' }"></v-breadcrumbs-item>
	...
	<h1 class="text-h5 text-center">TODO</h1>
	<v-divider></v-divider>
	...
	<p class="text-body-2 mt-6"><em>Powered by <a href="https://api.bible">api.bible</a></em></p>
</template>
